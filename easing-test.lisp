...
(defsketch visualization
    (:title "Easing" :width 1200 :height 600 :debug :scancode-f1 :y-axis :up)
    ((rows 4)
     (cols 8)
     (frames 0))
  (background (gray 0.8))
...
(defun run-visualization ()
  (make-instance 'visualization))
